...
import { ISearchResponse } from '../interfaces/common-interfaces';
...
const MockData = {
  ...
  meta: {
    status: 200,
    msg: 'OK',
    response_id: '8b2e5d7e1774fff7f4d8e48ab1aa049064da5e19'
  }
};
class MockGiphyService {
  static searchForGifs(): ISearchResponse {
    return MockData;
  }
}
...
describe('GiphyService', () => {
  ...
  it('searchForGifs should return ITrendingResponse object', () => {
    expect(MockGiphyService.searchForGifs()).toBe(MockData);
  });
});
